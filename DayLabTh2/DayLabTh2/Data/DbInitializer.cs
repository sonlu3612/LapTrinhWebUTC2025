    ...
    public class DbInitializer
    {
        public static void Initialize(IServiceProvider serviceProvider)
        {
                ...
                serviceProvider.GetRequiredService<DbContextOptions<SchoolContext>>()))
            {
                ...
                {
                    new Enrollment { LearnerID = 1, CourseID = 1050, Grade = 95 },
                    new Enrollment { LearnerID = 1, CourseID = 4022, Grade = 75 },
                    new Enrollment { LearnerID = 2, CourseID = 1050, Grade = 85 },
                    new Enrollment { LearnerID = 2, CourseID = 4041, Grade = 77 }
                };
